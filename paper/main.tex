...
Our theoretical contributions establish asymptotic normality and prove variance dominance over primary-only estimation. Empirically, DML achieves state-of-the-art performance on conjoint analysis, reducing MAPE from 32.0\% to 16.5\% (a 48\% relative improvement) versus primary-only estimation, while avoiding the failures of PPI when its assumptions are violated.
